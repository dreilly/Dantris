...
void Game::DrawPiece(int pX, int pY, int pPiece, int pRotation)
{
	...
	for (int i = 0; i < PIECE_BLOCKS; i++)
	{
		for (int j = 0; j < PIECE_BLOCKS; j++)
		{
			...
			{
			case 1: mColor = sf::Color::Green; break;  // For each block of the piece except the pivot
			case 2: mColor = sf::Color::Blue; break;   // For the pivot
			}
...
void Game::DrawBoard()
{
	...
	mIO->DrawRectangle(mX1 - BOARD_LINE_WIDTH, mY, mX1, mScreenHeight - 1, sf::Color::Blue);

	mIO->DrawRectangle(mX2, mY, mX2 + BOARD_LINE_WIDTH, mScreenHeight - 1, sf::Color::Blue);
